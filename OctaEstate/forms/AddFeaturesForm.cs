...
{
    public partial class AddFeaturesForm : Form
    {
        ...
        {
            data.Clear();
            data["feature_name"] = featureName.Value;
            data["feature_details"] = featureDetails.Value;
